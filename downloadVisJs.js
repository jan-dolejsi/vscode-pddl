...
const downloads = [
    {
        url: "https://unpkg.com/vis-network@9.1.4/dist/vis-network.min.js",
        options: {
    ...
    {
        url: "https://unpkg.com/vis-network@9.1.4/dist/vis-network.min.js.map",
        options: {
            directory: "views/common",
    ...
    {
        url: "https://unpkg.com/vis-network@9.1.4/dist/dist/vis-network.min.css",
        options: {
            directory: "views/common",
